...
status: proposed — decision (B) settled; ready for /openspec-apply
branch: tbd
---
...
This was surfaced during the independent review of [`chore-vps-access-hardening`](../changes/chore-vps-access-hardening/proposal.md) and initially described as "a live security defect." **Investigation does not support that.** The corrected assessment is below, because starting this work from the wrong premise would produce the wrong fix.

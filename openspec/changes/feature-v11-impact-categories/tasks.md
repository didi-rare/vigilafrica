# Tasks: v1.1 Impact Category Expansion
...
- [ ] 2.2 Add down migration that refuses narrowing while v1.1 category rows exist, or documents accepted cleanup
- [ ] 2.3 Verify existing flood/wildfire data survives the migration

## 3. EONET Ingestion

- [ ] 3.1 Update EONET request category parameter to include all v1.1 categories
- [ ] 3.2 Test request construction for the exact v1.1 category set
...
- [ ] 4.1 Update `GET /v1/events?category=` validation to accept all v1.1 categories
...
- [ ] 5.2 Add filter dropdown options for all v1.1 categories
...
- [ ] 6.5 Verify seeded v1.1 events enrich to country/ADM1 boundaries

## 7. Documentation and Verification

- [ ] 7.1 Update roadmap v1.1 section when implementation is complete
